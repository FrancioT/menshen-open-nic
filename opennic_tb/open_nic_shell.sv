...
`else // !`ifdef __synthesis__
  ...
  output     [NUM_CMAC_PORT-1:0] axis_adap_tx_250mhz_tvalid,
  output [512*NUM_CMAC_PORT-1:0] axis_adap_tx_250mhz_tdata,
  output  [64*NUM_CMAC_PORT-1:0] axis_adap_tx_250mhz_tkeep,
  output     [NUM_CMAC_PORT-1:0] axis_adap_tx_250mhz_tlast,
  output  [16*NUM_CMAC_PORT-1:0] axis_adap_tx_250mhz_tuser_size,
  output  [16*NUM_CMAC_PORT-1:0] axis_adap_tx_250mhz_tuser_src,
  output  [16*NUM_CMAC_PORT-1:0] axis_adap_tx_250mhz_tuser_dst,
  input     [NUM_CMAC_PORT-1:0] axis_adap_tx_250mhz_tready,
